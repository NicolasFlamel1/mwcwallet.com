<?php
	...
	$files = [
		...
		"./scripts/prices.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "kIi06i7mLnPPcY0qYAnamPGIjZOrVbTQgABvp0y5TDzl/q9pqtqUpC6aLWoQhbMsZ+xvu36qL2Ir5I1gI1007w=="
		],
		"./scripts/log.js" => [
			"Version" => 7,
			"Cache" => TRUE,
		...
		"./scripts/wallets.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "7iqrnlsi7s3nqR7xo7qVIoulNKDZu47f40RfQMsjbN/gduUx0HsdOCeFhZmz9Da66dtKZ/GPuErkO4k+H+rkrg=="
		],
		"./scripts/application.js" => [
			"Version" => 58,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "e5jxTv+ZCibDoafn0amweyLUwRVkOTh8k7vQLUemsknNz/yq8pbocb5YKTcKOx1/3lhL1aL1y+O7qJ9xzY8ufw=="
		],
		...
		"./scripts/language.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "9XqnwkH70YmV8RIRbhgZ3jxJm8z8UnuOfWxejFEXejjsC0ln6S07sMPTlrWZQ9eG4g/jvtaYEhn2aEA/Uf5h/g=="
		],
		...
		"./scripts/wallet.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "7eIOumsHGJVJBFVgGfY67lNxP+5JA/qeeqAvWObPXJ1RQrmpKi7KB9pjKNQRoo0Y4s6kvDhlxhkiHGsVllsXdQ=="
		],
		...
		"./scripts/transaction.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "nG5nVYe2gYGJa0bFGYAPQf0q1W3K2/XUx+MDJx+FwN4uvqDkXgXnzcXG6WyYrfqVLzF9U7Rgv34klg5DHrvdzw=="
		],
		"./scripts/transactions.js" => [
			"Version" => 17,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "gNLJgqO0v9TvDd/vSKSduJ8+rmk4wPZBbR6VRTDd/PsdHTg2BDkvHmw74I0Zy5LL4MoMqp7141ofHbN/6l1dZg=="
		],
		"./scripts/focus.js" => [
			"Version" => 6,
			"Cache" => TRUE,
		...
		"./scripts/api.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "Oa5foQUsK8vpwfRgt7xKfCRA4xk92n9EmrXH9EaFZz9JSHe1IKksqyziQzOaARGR4F4sbYe+4QosEjAL/pViUA=="
		],
		"./scripts/hardware_wallet.js" => [
			"Version" => 56,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "g8NJBP6XQ9jI8NEsIH4bfHsoHg8+8JzsWdVnorFrZa+CRGgGaBo+wScyE9nGWTGmVT5YW+t39LDo0e2+oEchoA=="
		],
		"./scripts/hardware_wallet_usb_transport.js" => [
			"Version" => 1,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "5CQPmiWc7Umk0EVUYY7qmo/DtctCNvqwZIkgPcKs4Ri4s0RpRIiGSq5stzsui3rbGUImD2iEdRaEE15UWIEURg=="
		],
		"./scripts/hardware_wallet_bluetooth_transport.js" => [
			"Version" => 1,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "5fNrqGbNufnS3IM7IVWMgAFTVdSNW1LebgHvs8QSclXV2tnndguJ/QxfgAAW9dJBpudyHuVAp+R4n9t58pHoBw=="
		],
		...
		"./scripts/listener.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "X1kqzT67e6WkUOpzJ9uu80MHPx41QT5pDhrUo/EHlr+C5WXkX8uDePYpTjvSPL3M0rHPE+9J+zGHhDVHpWwgUw=="
		],
		...
		"./scripts/json_rpc.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "gQMD6d0nWCsxi0ilN0xhTjzelBX+Xu1/7lCYe/CMIB7sqswAFL+DpeD0pAvJ36Tyg9PNgT9IGDzqnlj+KCmV+A=="
		],
		"./scripts/tor.js" => [
			"Version" => 10,
			"Cache" => TRUE,
		...
		"./scripts/slatepack.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "rpdWXxsIoZqElFvFhlxuefB7qJa0b7t940m2yWXZAYGCjbcNQ/Ip/osm3uqwS+k9KMQQkSJ6JTEhRwwcveg4nA=="
		],
		...
		"./scripts/node.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "5M8UYJ2Bq/rSwf/kuMBByaPdZECXYwWIAmt439z4rAXXnToe9HxG+pDRKAznY/RCFxBhVF2XQCDtplgYHpfqkg=="
		],
		"./scripts/message.js" => [
			"Version" => 17,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "pOnmagMXu3jBiX36qIpdaz9q3LgoLSMF42CQOP5ShykLhKAvg0lPedjpgJKctKG6XZ3inxXrjrgP2fueWF4xjQ=="
		],
		"./scripts/common.js" => [
			"Version" => 80,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "IpR+XMfKJ7z9hURxmq42/fBnQ7JTBAw2aC1noUfLoSFBcFSHYHycRI/DgkzUT23R+X48tvZtwYSouSubIQCnHw=="
		],
		...
		"./scripts/extension.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "SllMKT46UR2ZWSA+rQmGRBQKknNxjT8HVzJPturPITtnnk4Ucapi4tvq7oQpYbYSKrMJv0jeNngI6IwMOquAEA=="
		],
		"./scripts/version.js" => [
			"Version" => 11,
			"Cache" => TRUE,
		...
		"./scripts/settings_section.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "yUPo5H43pBwM5LCBxbKFozHbvx3ih9VgMYe6skvjmEtwW+MyFvV7G/QhDu8/s+2Bi9TbrxhfMldJbuGzbr3h+Q=="
		],
		"./scripts/about_section.js" => [
			"Version" => 8,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "dorub6PvTnThiacLGb7NCT9aNpwxW3DSN1o2+WDyKrQpzErrhFTdWodm4h1FM0BH6mbSC3u6O8F4sMCkBlkP0Q=="
		],
		"./scripts/transaction_section.js" => [
			"Version" => 23,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "m9SXoCWnSE3i+hDOPtbpJFes/Gd2txf27Z1FqC1FK/+OPFWPCipLd/Vmd7asEIn/VRTP9pqa0lI6gLWrGXJocg=="
		],
		...
		"./scripts/wallet_section.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "wftglq8fyNWfTCcKuYrKWrWht5Mnn1s4xsLeFnqD9h7ix6SbREeOSxq72r9hFdtGNSqE99pTdEz9cu2ULMYPAw=="
		],
		"./scripts/send_payment_section.js" => [
			"Version" => 67,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "bOi1ohi6C9FqV9q6PmTC8YrEOhOtl0sSe06ld0tMM3u7gLiHBwQyAfMgRKC1tLT9Ve/00ioDSbg6FrX7tCWzkA=="
		],
		...
		"./scripts/recent_heights.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "7vqoTweNpCBrXyJZsBbZy8/ksugVBMfbsWgT5vAp+hQzTtBoMcW4MVhFKuTpXLV1q+/Z6cR56QEZJqXJBH1UYg=="
		],
		...
		"./scripts/unlocked.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "V7EJVXHz80uATgwyrTF1lvLAXjWS1Anl8sh1SpU3+nXfyDuiYSET7lCcJGl/tHZrXwPVRqtgslMuNRHTqjbSUw=="
		],
		"./scripts/uuid.js" => [
			"Version" => 5,
			"Cache" => TRUE,
		...
		"./scripts/slate.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "tOwbAZbDQlbtEh6/88YKwhIh5547+P5d1bCApAjk5reupDXUsJ78hT2cxjMTIEu4tWVFFwkOwnGADcYoGXSsGw=="
		],
		"./scripts/slate_participant.js" => [
			"Version" => 9,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "dg7BoWAtzf3UfCVWjYAZ576XVZ203R/jGtuA1I9JgnryUHgyEW8AB5u5rfSdf3Z546mzM8j6wHYA9pWgOduyfQ=="
		],
		...
		"./styles/transaction_section.css" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "Xc/rNNOgCeztBbyjiClUPDJKe5v9jcQttjqCuuFAeGIL6ZjG/DxpKLNIHjMNi9CpAmfY/mGbF7yv52nrBDfU/Q=="
		],
		...
		"./styles/message.css" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "KVSqhYKJPwgkYaT8zQf64d2HkorfLMoSaUsmTGLhar+h4ybKnjSZPaha4vl9utnUUEV0xN5xXRQNd5JHTgZW/w=="
		],
		"./styles/tetris.css" => [
			"Version" => 3,
			"Cache" => TRUE,
