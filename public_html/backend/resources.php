<?php
	...
	$files = [
		...
		"./scripts/prices.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "DBXEm0vjNC62DbLorHeOuROahiyR/eE/9kaYfUYPbfwKNDgjW4e8a45+o0pXz+ODENw5s04aBsRiy93PVboYqA=="
		],
		"./scripts/log.js" => [
			"Version" => 6,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "D+ial2YdsShoG56Eg3emUCZVvdDVgap2JLJwSv7gt0s2g05ATnNO1xY7iwrDHiGbwU/1X/HFjkot1HFe8+WmzA=="
		],
		...
		"./scripts/application.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "v3fZpUsT+1Fj0p3mygxe50+trflT/kpe43XSHT6lecX96dBh1YwZqlZd0o1ZADwhYFF5xRXY92t6rdVCFv5GvQ=="
		],
		...
		"./scripts/language.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "qj8ytzHzjjS5DrQxevTC/+Obr9jYtLnDKcSwt7U1ZD+TEM6tW9kApfwXImCdCFn6K9jtBDi0czWrpQs4ARiROw=="
		],
		...
		"./scripts/tetris.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "0uU7W/JgBZhdgjx68WzxI7/tOqxztbp73mU9rfhx7Xo1JUddkbhA2vGg7lynmEEMgBOKQSmsCcEVZSnHSFcuXw=="
		],
		"./scripts/logo.js" => [
			"Version" => 10,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "2Ym+xSR7HHtPn0IPn4jG85P9Fjt0UbonI6cGXZwApDW48kaPVXxOQ96BV+3N9hY7copnoTa3Oi4Uuanrg0qYQw=="
		],
		...
		"./scripts/listener.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "4YQyLSmj2ieMU8AjqM6MMrFmc1zzZx0AO3uahLXgBbRn+zMV01KegtPLUmbD0WmXsDIK91OrtD9qejBtCOLx6Q=="
		],
		...
		"./scripts/message.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "q5m1Xa5nHuPxxScAvBRFxhrLOgcVjbvJXNa7xzcNFl+ltO25dJwI4l/071qODHLBODMPZGPyDDa8sLO50kkSmA=="
		],
		"./scripts/common.js" => [
			"Version" => 67,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "DXxJwXvC3Rm6VOgh2ffeMYvVWWyYLTvS3EWAq3Jh1y78PGQFvH4e9Gn6svtYRRLEh0XZVa2bu7iD/tcLVJqL3Q=="
		],
		...
		"./scripts/section.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "AepWD6zqgIREmV7tS2rbkvofkE9xGzCetMpAGqBV+Of4O5HyIWm+xSJJD8PoaKeKrztlymiY8j0LjtmHIP3Ekg=="
		],
		"./scripts/settings_section.js" => [
			"Version" => 10,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "iDx8LWwgINSmFy971Y0Wy2OQPO4PwLVrv8Iyrc5CP/mk8KU3xbnZJ6P9uva52vCQOR9eGK5nXUpKb0RHJj4fiw=="
		],
		...
		"./scripts/transaction_section.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "yM+CxVYd53VIV6H44FNesxLDN3ervys+4SxsPmRmtfsOTg4ixyOHQ8kMeHSFNuxmCRew1P9l8xVt4RnopOhABQ=="
		],
		...
		"./scripts/wallet_section.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "zlPUkZMXFix6BKYYzX449mtc0GIWFWYUcteN2bIFSMnKcrbo7P9ZD8v2DXJKeUmMd/qpAfPDzqz5/Qj2RTNdPw=="
		],
		...
		"./scripts/unlocked.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "iUpMoiM5h/JqLItPaQ+cDcjYLsrl6dxo12UDxcmWbGRRLFaQSM2HhaNP7ywZuWqMzKYDcDrG4fkGtVBVBEqCtg=="
		],
		"./scripts/uuid.js" => [
			"Version" => 5,
			"Cache" => TRUE,
		...
		"./scripts/slate_participant.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "rydB/Sud11MC+o4F2p58H9MyI1j+d8V5JBhCWt1VEixgdX9ujf7RUw+VSJ0e6RS7nS88a/f8rwTbW85NW7ij7w=="
		],
		...
		"./images/countries/france.svg" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "knu23fC/ppYdZtdvXCTVm07sIMuvCZmq4TY7+wWyUZDnPI8KwBpMLP0ultqulYTBcF+F2xHmjVbQDCPaN3TI+A=="
		],
		...
		"./styles/cookie_acceptance.css" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "M4gpn1D7GMUFsQAwyD3a6JiuVTM6GNFY38fgr4BQ2L2mmZ9Ttu3diH6tX++u52zZjSQqUmYCCPb3Gc4OndmjRA=="
		],
		"./styles/language.css" => [
			"Version" => 4,
			"Cache" => TRUE,
		...
		"./styles/wallet_section.css" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "6IS6Tdr9Q/+eZelgfEvo0hjirsdCrJmQR3ws6frHH+nJe1sU+uPexc/2ONKbzSnA4tA6vKdjJkVNve3DbOLecg=="
		],
		...
		"./styles/maintenance_notification.css" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "tLyNIoKGnhB5x3acZwfFMpVsk3W1c768tXoHexiADeK9mRFfqX/jmkCL8wtgMT1vk/gnRs96qOKxUoEV8/UUyw=="
		],
		"./styles/install_app.css" => [
			"Version" => 9,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "/23WiQXY1lWC4eFca7M08goIsofCjRgM7eZAD7Ubf4fHMQ0CafUalCZVcdr963h1COUjtg/f5mBakhMt/YwgPw=="
		],
