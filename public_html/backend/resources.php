<?php
	...
	$files = [
		...
		"./scripts/prices.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "jC+0bJ9tUL8tXzh0QwK3Y5k4VTLVsJCa+pEIJDkNC3l73U05KvjXC6EHOBJsTA5asmh5Sgvt5y5fZS7vTDCMNA=="
		],
		"./scripts/log.js" => [
			"Version" => 7,
			"Cache" => TRUE,
		...
		"./scripts/wallets.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "wDL92nsAwtXXUdTrVW1SdmAxVRH3385pLSAmSj/i1MXZuyEMUmE54bYuxs7B6Hvkq4p6L8muOMaAM7UvcPK4AA=="
		],
		"./scripts/application.js" => [
			"Version" => 57,
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "KynpiG1qrq5LvgolZeG/18AXGroVKKCuTOVop5Djc4O1hCECqO9G4oXWTI90JxsQnS5+5Dz0/dJ7SLttxNTuog=="
		],
		...
		"./scripts/transactions.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "st2mTL666u7PCCO/1QusqdlLe226pCh/PfoRlQBCuOFxNnvisYBOCEbdhoUNdi7T/SH3JrbwpcmP3tdD6txaAg=="
		],
		"./scripts/focus.js" => [
			"Version" => 6,
			"Cache" => TRUE,
		...
		"./scripts/api.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "VLulZ+1rwenCKtSE9HPETYFWftyONzsk2w3XaGbADG3iL95PQTSb7LWYO7k0s6FL8AuXJ9XTII3/7PGC4F22sg=="
		],
		...
		"./scripts/hardware_wallet.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "Cj9wr9uDgkOvBXcrLO9UCz6B+hruIhBXaEm3KKL9+TdZh54Cc5QYWl0Z5iQUD5oxnJakEqC8Wz7Q84iH6cD3nA=="
		],
		...
		"./scripts/output.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "v83wD5sSujPRy/EH19yeA5ZBOg6Q6Arr9VJgAm5O32YfvmWT3l7hJAF7W4nwdrun3TEFwrgDQsOw8vLVICwh+A=="
		],
		...
		"./scripts/mqs.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "g/V6L4H8o2IKlS6HPoJy1JRTOl4DH8gqHWVbG4gPmPvWl5iHQsWvNV1EqQuRvOd0VZB1SxIZO4PT6xPb9Nr62Q=="
		],
		...
		"./scripts/common.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "WZH3ceKT7lixKHKHjjSDM+5QlfSQVYMfHTLkHnOj74XgVbaVZi9GkuYyVJuZgZwzg2dGkkzL9oJFN7nAcbiICA=="
		],
		...
		"./scripts/transaction_section.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "yeT6U97Xp6gvmXRFwB+RSSeYC5xMN9DWTG8CX4nfQ1IqUT3CVHZp+Iiy7MRv/IPFrw8pQ9PU5C3Snver2dyEUQ=="
		],
		...
		"./scripts/wallet_section.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "lWDoVXzhw1K4Cv0hDM/zZ34Pe1h+ZpGjBxeOnce5VIac0HfSvjMqXxfhOAQTSx8QdvBVTAgqaf5oALhUyy5TTg=="
		],
		...
		"./scripts/unlocked.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "rnnyiUxHl3/CNSowuS4XuOdi4022T6qpFKotIBb/t3KT+QXD+XfFGRT1WaRWrCRfTwEES4JDOqIApiQwNej+OA=="
		],
		"./scripts/uuid.js" => [
			"Version" => 5,
			"Cache" => TRUE,
		...
		"./styles/message.css" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "yqcUgldgYh+IApy6ddC73nAE+fGkTh8siUFN4JS5iu910ztphx92OtBPl5gD9CAMRGDS3e/8XjDxrZbcIrFFsQ=="
		],
		"./styles/tetris.css" => [
			"Version" => 3,
			"Cache" => TRUE,
