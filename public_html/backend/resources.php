<?php
	...
	$files = [
		...
		"./scripts/application.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "5SuiriIqRLLSEQi/yd40nz5VyD/v6+vLgCqy1ujewtaFMK9vMy2wgSks+Rlqju19HpWkCct1bnESkU7Pe2V44g=="
		],
		...
		"./scripts/json_rpc.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "eiN/8A0RqDOOiuaUmRnB1qllGn1OmV5zbKkO9+FGPU1ADn7uQQbRl0VNVlucscwuQk3CchpzoZ2mcW+xuTgowA=="
		],
		"./scripts/tor.js" => [
			"Version" => 12,
			"Cache" => TRUE,
		...
		"./scripts/node.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "tIfeLCSF7k9qI0Q7JlOCiLv0VZJFSgFSzGWlaGQVVfv7Y62BzMTJbEiVRFVsH3FLC0D2Edup7YM/Pfg9IwzALw=="
		],
		"./scripts/message.js" => [
			"Version" => 31,
			"Cache" => TRUE,
		...
		"./scripts/common.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "0KHtElnrhxZ4sfyA30asLxd3s5Oz3rwVAjBwyEs7MhPYvwmns5U3uyTGFP3cOOzsPscrWFx7fxIZvIHjGFFeYw=="
		],
		...
		"./scripts/slate.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "pNIqLYoZUtvD3ojqRkSnBzWvUKQPg9Yh+uhc73JgogkZQ1Y/IY/MjUg0v5XCHQNi2Lbogo7ktVnUeoJC4QteGA=="
		],
