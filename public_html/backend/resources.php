<?php
	...
	$files = [
		...
		"./scripts/wallets.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "kaHXuH6iCepS+yTvrG0z5NmAc6DkMay9J7E13gcYtZfXFVec9F6AYRdw4brsNqeH0frlT3JmcDnP/QLHciwTkg=="
		],
		...
		"./scripts/language.js" => [
			...
			"Cache" => TRUE,
			"Minified" => FALSE,
			"Checksum" => "CpaKdigTxBMCAKtNXkkRM5MdX6Pg/NAxPzV9slolknoWerDd+iGRW2s05DMEVJ3eXhIyxf/CjdtUHT4o+et1kQ=="
		],
