<?php
	...
	$availableLanguages["el-GR"] = [
		...
		"Text" => [
			...
			'Cancel Transaction Error' => 'Σφάλμα ακύρωσης συναλλαγής',
			...
			'Confirm new password is empty.' => 'Επιβεβαιώστε ότι ο νέος κωδικός πρόσβασης είναι κενός.',
			'Confirm Password' => 'Επιβεβαίωση Κωδικού',
			'Confirm password is empty.' => 'Επιβεβαιώστε ότι ο κωδικός πρόσβασης είναι κενός.',
			...
			'Connecting to that %1$x hardware wallet failed.' => 'Η σύνδεση σε αυτό το πορτοφόλι υλικού %1$x απέτυχε.',
			...
			'Down' => 'Κάτω',
			'Each wallet can only be recovered by using its passphrase once it\'s been deleted.' => 'Κάθε πορτοφόλι μπορεί να ανακτηθεί μόνο χρησιμοποιώντας τη φράση πρόσβασής του αφού διαγραφεί.',
			...
			'Network type: %1$x' => 'Τύπος δικτύου: %1$x',
			...
			'Rebroadcast Transaction' => 'Συναλλαγή αναμετάδοσης',
			'Rebroadcast Transaction Error' => 'Σφάλμα συναλλαγής αναμετάδοσης',
			'Received' => 'Ελήφθη',
			...
			'Receiver payment proof address:' => 'Διεύθυνση απόδειξης πληρωμής παραλήπτη:',
			'Receiver payment proof signature:' => 'Υπογραφή αποδεικτικού πληρωμής παραλήπτη:',
			...
			'Recorded time: %1$d at %2$t' => 'Χρόνος εγγραφής: %1$d στις %2$t',
			'Recover' => 'Ανάκτηση',
			...
			'Release date: %1$d' => 'Ημερομηνία κυκλοφορίας: %1$d',
			...
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and that there\'s no recipient payment proof address displayed.' => 'Βεβαιωθείτε ότι το ποσό που εμφανίζεται στο πορτοφόλι υλικού είναι %1$c, το τέλος πληρωμής που εμφανίζεται είναι %2$c, τα χαρακτηριστικά του πυρήνα που εμφανίζονται είναι %3$x και ότι δεν εμφανίζεται η διεύθυνση απόδειξης πληρωμής του παραλήπτη.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and that there\'s no sender payment proof address displayed.' => 'Βεβαιωθείτε ότι το ποσό που εμφανίζεται στο πορτοφόλι υλικού είναι %1$c, το τέλος πληρωμής που εμφανίζεται είναι %2$c, τα χαρακτηριστικά του πυρήνα που εμφανίζονται είναι %3$x και ότι δεν εμφανίζεται διεύθυνση απόδειξης πληρωμής αποστολέα.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the recipient payment proof address displayed matches the following payment proof address.' => 'Βεβαιωθείτε ότι το ποσό που εμφανίζεται στο πορτοφόλι υλικού είναι %1$c, το τέλος πληρωμής που εμφανίζεται είναι %2$c, τα χαρακτηριστικά του πυρήνα που εμφανίζονται είναι %3$x και ότι η διεύθυνση απόδειξης πληρωμής του παραλήπτη που εμφανίζεται αντιστοιχεί στην ακόλουθη διεύθυνση απόδειξης πληρωμής.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the sender payment proof address displayed matches the following payment proof address.' => 'Βεβαιωθείτε ότι το ποσό που εμφανίζεται στο πορτοφόλι υλικού είναι %1$c, το τέλος πληρωμής που εμφανίζεται είναι %2$c, τα χαρακτηριστικά του πυρήνα που εμφανίζονται είναι %3$x και η διεύθυνση απόδειξης πληρωμής του αποστολέα που εμφανίζεται αντιστοιχεί στην ακόλουθη διεύθυνση απόδειξης πληρωμής.',
			...
			'Version number: %1$v' => 'Αριθμός έκδοσης: %1$v',
			...
			'Wallet type: %1$x' => 'Τύπος πορτοφολιού: %1$x',
			...
			'You can\'t guarantee that this payment is going to the intended recipient since this transaction doesn\'t have a payment proof.' => 'Δεν μπορείτε να εγγυηθείτε ότι αυτή η πληρωμή θα γίνει στον προοριζόμενο παραλήπτη, καθώς αυτή η συναλλαγή δεν διαθέτει απόδειξη πληρωμής.',
