<?php
	...
	$availableLanguages["el-GR"] = [
		...
		"Text" => [
			...
			'Down' => 'Κάτω',
			'Each wallet can only be recovered by using its passphrase or hardware wallet once it\'s been deleted.' => 'Κάθε πορτοφόλι μπορεί να ανακτηθεί μόνο χρησιμοποιώντας τη φράση πρόσβασής του αφού διαγραφεί.',
			...
			'This wallet can only be recovered by using its passphrase or hardware wallet once it\'s been deleted.' => 'Αυτό το πορτοφόλι μπορεί να ανακτηθεί μόνο χρησιμοποιώντας τη φράση πρόσβασής του αφού διαγραφεί.',
