<?php
	...
	$availableLanguages["nl-NL"] = [
		...
		"Text" => [
			...
			'Down' => 'Buiten gebruik',
			'Each wallet can only be recovered by using its passphrase or hardware wallet once it\'s been deleted.' => 'Wanneer een portemonnee verwijderd is, kan deze enkel hersteld worden door gebruik te maken van de bijbehorende wachtwoordzin.',
			...
			'This wallet can only be recovered by using its passphrase or hardware wallet once it\'s been deleted.' => 'Deze portemonnee kan alleen hersteld worden door gebruik te maken van bijbehorende wachtwoordzin indien deze eenmaal verwijderd is.',
