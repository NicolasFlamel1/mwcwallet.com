<?php
	...
	$availableLanguages["nl-NL"] = [
		...
		"Text" => [
			...
			'Connecting to that %1$x hardware wallet failed.' => 'Verbinden met die %1$x hardware portemonnee is mislukt.',
			...
			'Down' => 'Buiten gebruik',
			'Each wallet can only be recovered by using its passphrase once it\'s been deleted.' => 'Wanneer een portemonnee verwijderd is, kan deze enkel hersteld worden door gebruik te maken van de bijbehorende wachtwoordzin.',
			...
			'Rebroadcast Transaction Error' => 'Opnieuw Uitzenden Transactie Fout',
			'Received' => 'Ontvangen',
			...
			//'Testnet' => 'Testnet',
			'That hardware wallet isn\'t connected.' => 'Die hardware portemonnee is niet verbonden.',
			...
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the sender payment proof address displayed matches the following payment proof address.' => 'Verifieer dat de hoeveelheid weergegeven op de hardware wallet %1$c is, de weergegeven vergoeding %2$c is, de weergegeven kernel kenmerken %3$x is, en dat het weergegeven betalingsbewijs adres van de zender overeenkomt met het volgende betalingsbewijs adres.',
			...
			'Wallet type: %1$x' => 'Portemonnee type: %1$x',
