<?php
	...
	$availableLanguages["zh-CN"] = [
		...
		"Text" => [
			...
			'Cancel Transaction Error' => '取消交易错误',
			...
			/*TODO*/'Confirm new password' => '确认新密码',
			/*TODO*/'Confirm new password is empty.' => '确认新密码为空。',
			/*TODO*/'Confirm Password' => '确认密码',
			/*TODO*/'Confirm password is empty.' => '确认密码为空。',
			'Confirm Payment Details' => '确认付款详情',
			'Connect' => '连接',
			'Connecting to a hardware wallet.' => '连接到硬件钱包。',
			'Connecting to a node failed.' => '连接节点失败。',
			'Connecting to that %1$x hardware wallet failed.' => '连接到硬件钱包 %1$x 失败。',
			...
			'Down' => '向下',
			'Each wallet can only be recovered by using its passphrase once it\'s been deleted.' => '每个钱包仅可通过使用其密钥恢复一次，一旦已删除，就无法再次恢复。',
			...
			'Rebroadcast Transaction' => '重新广播交易',
			'Rebroadcast Transaction Error' => '重新广播交易错误',
			'Received' => '已收到',
			...
			'Receiver payment proof address:' => '收款方支付证明地址：',
			'Receiver payment proof signature:' => '收款方支付证明签名：',
			...
			'Recorded time: %1$d at %2$t' => '记录时间：%2$t中的%1$d',
			'Recover' => '恢复',
			...
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and that there\'s no recipient payment proof address displayed.' => '请验证硬件钱包上显示的金额为 %1$c，手续费为 %2$c，核心特征为 %3$x，并且没有显示收款人付款证明地址。',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and that there\'s no sender payment proof address displayed.' => '请验证硬件钱包上显示的金额为 %1$c，手续费为 %2$c，核心特征为 %3$x，并且没有显示发件人付款证明地址。',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the recipient payment proof address displayed matches the following payment proof address.' => '请验证硬件钱包上显示的金额为 %1$c，手续费为 %2$c，核心特征为 %3$x，并且显示的收款人付款证明地址与以下付款证明地址匹配。',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the sender payment proof address displayed matches the following payment proof address.' => '请验证硬件钱包上显示的金额为 %1$c，手续费为 %2$c，核心特征为 %3$x，并且显示的发件人付款证明地址与以下付款证明地址匹配。',
			...
			'Version number: %1$v' => '版本号：%1$v',
			'Wallet %1$s' => '钱包“%1$s”',
			'Wallet Error' => '钱包错误',
			'Wallet Renamed' => '钱包重命名',
			'Wallets' => '钱包',
			'Wallet Settings' => '钱包设置',
			'Wallet type: %1$x' => '钱包类型：%1$x',
			...
			'You can\'t guarantee that this payment is going to the intended recipient since this transaction doesn\'t have a payment proof.' => '由于此交易没有付款证明，您无法确保此付款到达预期的收款方。',
			...
			'You\'re sending %1$c for a fee of %2$c, and the recipient\'s payment proof address is the following payment proof address.' => '您正在发送%1$c，手续费为%2$c，收件人的付款证明地址是以下付款证明地址。',
			'You\'re sending %1$c for a fee of %2$c, and this transaction doesn\'t have a payment proof.' => '您正在发送%1$c，手续费为%2$c，此交易没有付款证明。',
