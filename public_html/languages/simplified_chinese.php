<?php
	...
	$availableLanguages["zh-CN"] = [
		...
		"Text" => [
			...
			'Down' => '向下',
			'Each wallet can only be recovered by using its passphrase or hardware wallet once it\'s been deleted.' => '每个钱包仅可通过使用其密钥恢复一次，一旦已删除，就无法再次恢复。',
			...
			'This wallet can only be recovered by using its passphrase or hardware wallet once it\'s been deleted.' => '此钱包只能在删除后使用其密语进行恢复。',
