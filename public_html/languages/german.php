<?php
	...
	$availableLanguages["de-DE"] = [
		...
		"Text" => [
			...
			//'Down' => 'Down',
			'Each wallet can only be recovered by using its passphrase or hardware wallet once it\'s been deleted.' => 'Jedes Wallet kann nur wiederhergestellt werden, indem ihre Passphrase verwendet wird, nachdem sie gelöscht wurde.',
			...
			'This wallet can only be recovered by using its passphrase or hardware wallet once it\'s been deleted.' => 'Diese Brieftasche kann nur wiederhergestellt werden, indem ihre Passphrase verwendet wird, nachdem sie gelöscht wurde.',
