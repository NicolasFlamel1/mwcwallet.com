<?php
	...
	$availableLanguages["de-DE"] = [
		...
		// Contributors
		"Contributors" => [
			"High ko XMR" => "https://twitter.com/@AlphaElektron"
		],
		...
		"Text" => [
			...
			'Cancel Transaction Error' => 'Transaktionsfehler abbrechen',
			...
			'Connecting to that %1$x hardware wallet failed.' => 'Die Verbindung mit dieser Hardware-Wallet %1$x ist fehlgeschlagen.',
			...
			//'Down' => 'Down',
			'Each wallet can only be recovered by using its passphrase once it\'s been deleted.' => 'Jedes Wallet kann nur wiederhergestellt werden, indem ihre Passphrase verwendet wird, nachdem sie gelöscht wurde.',
			...
			'Network type: %1$x' => 'Netzwerk type: %1$x',
			...
			'Rebroadcast Transaction' => 'Transaktion für erneute Übertragung',
			'Rebroadcast Transaction Error' => 'Transaktionsfehler bei erneuter Übertragung',
			'Received' => 'Empfangen',
			...
			'Receiver payment proof address:' => 'Zahlungsnachweisadresse des Empfängers:',
			'Receiver payment proof signature:' => 'Unterschrift des Zahlungsnachweises des Empfängers:',
			...
			'Recorded time: %1$d at %2$t' => 'Aufnahme Zeit: %1$d at %2$t',
			...
			'Release date: %1$d' => 'Veröffentlichungsdatum: %1$d',
			...
			'Transaction Information' => 'Transaktion Information',
			...
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and that there\'s no recipient payment proof address displayed.' => 'Stellen Sie sicher, dass der auf der Hardware-Wallet angezeigte Betrag %1$c beträgt, die angezeigte Gebühr %2$c beträgt, die angezeigten Kernel-Funktionen %3$x betragen und keine Zahlungsnachweisadresse des Empfängers angezeigt wird.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and that there\'s no sender payment proof address displayed.' => 'Stellen Sie sicher, dass der auf der Hardware-Wallet angezeigte Betrag %1$c beträgt, die angezeigte Gebühr %2$c beträgt, die angezeigten Kernel-Funktionen %3$x betragen und keine Zahlungsnachweisadresse des Absenders angezeigt wird.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the recipient payment proof address displayed matches the following payment proof address.' => 'Vergewissern Sie sich, dass der auf der Hardware-Wallet angezeigte Betrag %1$c beträgt, die angezeigte Gebühr %2$c beträgt, die angezeigten Kernelfunktionen %3$x betragen und die angezeigte Zahlungsnachweisadresse des Empfängers mit der folgenden Zahlungsnachweisadresse übereinstimmt.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the sender payment proof address displayed matches the following payment proof address.' => 'Vergewissern Sie sich, dass der auf der Hardware-Wallet angezeigte Betrag %1$c beträgt, die angezeigte Gebühr %2$c beträgt, die angezeigten Kernelfunktionen %3$x betragen und die angezeigte Zahlungsnachweisadresse des Absenders mit der folgenden Zahlungsnachweisadresse übereinstimmt.',
			...
			'You can\'t guarantee that this payment is going to the intended recipient since this transaction doesn\'t have a payment proof.' => 'Sie können nicht garantieren, dass diese Zahlung an den beabsichtigten Empfänger geht, da für diese Transaktion kein Zahlungsnachweis vorliegt.',
			...
			'You\'re sending %1$c for a fee of %2$c, and the recipient\'s payment proof address is the following payment proof address.' => 'Sie senden %1$c gegen eine Gebühr von %2$c und die Zahlungsnachweisadresse des Empfängers ist die folgende Zahlungsnachweisadresse.',
			'You\'re sending %1$c for a fee of %2$c, and this transaction doesn\'t have a payment proof.' => 'Sie senden %1$c gegen eine Gebühr von %2$c und für diese Transaktion gibt es keinen Zahlungsnachweis.',
