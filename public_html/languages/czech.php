<?php
	...
	$availableLanguages["cs-CZ"] = [
		...
		"Text" => [
			...
			'Cancel Transaction' => 'Zrušit transakci',
			'Cancel Transaction Error' => 'Chyba zrušení transakce',
			...
			'Connecting to that %1$x hardware wallet failed.' => 'Připojení k %1$x hardware peněžence se nezdařilo.',
			...
			'Down' => 'Dolů',
			'Each wallet can only be recovered by using its passphrase once it\'s been deleted.' => 'Každá peněženka může být obnovena bezpečnostní frází pouze po té, co byla daná peněženky smazána.',
			...
			'Network type: %1$x' => 'Druh sítě: %1$x',
			...
			'Rebroadcast Transaction' => 'Znovuvyslat transakci',
			'Rebroadcast Transaction Error' => 'Chyba znovuvyslání transakce',
			'Received' => 'Přijato',
			...
			'Receiver payment proof address:' => 'Adresa příjemce pro potvrzení o platbě:',
			'Receiver payment proof signature:' => 'Podpis příjemce pro potvrzení o platbě:',
			...
			'Recorded time: %1$d at %2$t' => 'Zaznamenaný čas: %1$d v %2$t',
			'Recover' => 'Obnovit',
			...
			'Release date: %1$d' => 'Datum vydání: %1$d',
			...
			//'Testnet' => 'Testnet',
			'That hardware wallet isn\'t connected.' => 'Daná hardware peněženka není připojena.',
			...
			'Transaction Information' => 'Informace o transakci',
			...
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and that there\'s no recipient payment proof address displayed.' => 'Ověřte, že částka zobrazená na hardwarové peněžence je %1$c, zobrazený poplatek je %2$c, zobrazená kernel charakteristika je %3$x a že není zobrazena adresa příjemce pro potvrzení o platbě.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and that there\'s no sender payment proof address displayed.' => 'Ověřte, že částka zobrazená na hardwarové peněžence je %1$c, zobrazený poplatek je %2$c, zobrazená kernel charakteristika je %3$x a že není zobrazena adresa odesílatele pro potvrzení o platbě.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the recipient payment proof address displayed matches the following payment proof address.' => 'Ověřte, že částka zobrazená na hardwarové peněžence je %1$c, zobrazený poplatek je %2$c, zobrazená kernel charakteristika je %3$x a že adresa příjemce pro potvrzení o platbě je shodná s následující adresou potvrzení o platbě.',
			'Verify that the amount displayed on the hardware wallet is %1$c, the fee displayed is %2$c, the kernel features displayed is %3$x, and the sender payment proof address displayed matches the following payment proof address.' => 'Ověřte, že částka zobrazená na hardwarové peněžence je %1$c, zobrazený poplatek je %2$c, zobrazená kernel charakteristika je %3$x a že adresa odesílatele pro potvrzení o platbě je shodná s následující adresou potvrzení o platbě.',
			...
			'Version number: %1$v' => 'Číslo verze: %1$v',
			...
			'Wallet type: %1$x' => 'Typ Peněženky: %1$x',
			...
			'You can\'t guarantee that this payment is going to the intended recipient since this transaction doesn\'t have a payment proof.' => 'Vzhledem k tomu, že tato transakce neobsahuje potvrzení o platbě, nelze zaručit, že zamíří k zamýšlenému příjemci.',
			...
			'You\'re sending %1$c for a fee of %2$c, and the recipient\'s payment proof address is the following payment proof address.' => 'Odesíláte %1$c s poplatkem %2$c, adresa příjemce pro potvrzení o platbě je následující.',
			'You\'re sending %1$c for a fee of %2$c, and this transaction doesn\'t have a payment proof.' => 'Odesíláte %1$c s poplatkem %2$c, a tato platba neobsahuje potvrzení o platbě.',
